 ...
 */
package com.adobe.aem.learning.core.listeners;
...
public class SimpleResourceListener implements EventHandler {
    ...
    public void handleEvent(final Event event) {
        logger.error("AEM learning Resource event: {} at: {}", event.getTopic(), event.getProperty(SlingConstants.PROPERTY_PATH));
    }
}
